  ...
  return (
    ...
    >
      <div
        ...
        flex-col justify-between items-center max-w-7xl mx-auto absolute top-[170px] xl:top-[100px]  flex    gap-5`}
      >
      ...
      <div className="  absolute  xs:bottom-[-22px] bottom-2 w-full flex justify-center items-center">
        <a href="#about">
